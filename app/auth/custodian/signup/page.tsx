...
export default function CustodianSignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F9F9F9]">
      <div className="w-full max-w-[528px] mx-4 flex flex-col items-center gap-[60px] rounded-[30px] border border-[#E8E8E8] bg-white p-8 md:p-12">
        ...
        {/* Footer Links */}
        <div className="text-sm font-medium leading-[145%] text-center text-[#484848]">
          By continuing, you agree to StrataFi's{' '}
          <Link href="/terms" className="text-[#F44C15] underline font-normal">
            Terms
          </Link>
          ,{' '}
          <Link href="/privacy" className="text-[#F44C15] underline font-normal">
            Privacy Policy
          </Link>
          , and{' '}
          <Link href="/compliance" className="text-[#F44C15] underline font-normal">
